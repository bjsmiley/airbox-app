use std::{fmt, ops::Deref, net::Ipv4Addr};
...
impl PeerId {
    ...
    pub fn from_string(id: String) -> Result<PeerId, PeerIdError> {
        if id.len() != 40 {
...
/// The common name of the identity certificate generated by ab-cdp.
const CERTIFICATE_COMMON_NAME: &str = "ab-p2p-identity";
...
impl Identity {
    ...
    pub fn new() -> Self {
        ...
        parameters.distinguished_name.push(DnType::CommonName, CERTIFICATE_COMMON_NAME);
	...
	pub fn into_rustls(self) -> (rustls::Certificate, rustls::PrivateKey) {
		(rustls::Certificate(self.certificate), rustls::PrivateKey(self.private_key))
	}
